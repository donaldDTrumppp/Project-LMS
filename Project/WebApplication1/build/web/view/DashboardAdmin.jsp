            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="llist?act=list">
                                <i class="fa fa-gavel"></i> <span>Lesson List</span>
                            </a>
                        </li>
                        <li>
                            <a href="TraineeList">
                        ...
                        <li>
                            <a href="sjlist?act=list">
                                <i class="fa fa-gavel"></i> <span>Subject Management</span>
                            </a>
                        </li>
                    </ul>
                </section>
                    ...
                    <div class="my-div">
                        ...
                        <header>
                            <style>
                                ...
                                /* ??nh d?ng cho ng�y b?t ??u v� ng�y k?t th�c */
                                .dates {
                                    margin-top: 10px;
                                    /* Kho?ng c�ch t? t�n l?p */
                                }
                        ...
                        <body>
                            <div class="box-container">
                                <c:forEach var="dashboard" items="${list}">
                                    <div class="box">
                                        <div class="course-code"><strong>${dashboard.subjectcode} -
                                                ${dashboard.getSemester()}</strong></div>
                                        <div>
                                            <span class="blk">Class:</span>${dashboard.classname}
                                        </div>
                                        <div>
                                            <span class="blk">Start date:</span>${dashboard.getStartT()}
                                            ${dashboard.getStartS()}<br>
                                        </div>
                                        <div>
                                            <span class="blk">End date:</span>${dashboard.getEndT()}
                                            ${dashboard.getEndS()}
                                        </div>
                                        <div>
                                            <button class="btn btn-primary btn-addon btn-sm"
                                                onclick="learn('${dashboard.getSubject()}', '${dashboard.getClassid()}')">
                                                Go to subject
                                            </button>
                                        </div>
                                    </div>
