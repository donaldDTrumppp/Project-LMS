            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="exquizls">
                                <i class="fa fa-gavel"></i> <span>Extra Quiz Management</span>
                            </a>
                        </li>
                    </ul>
                </section>
                        ...
                        <header>
                            <style>
                                ...
                                .box {
                                    ...
                                    border-radius: 12px;
                                    padding: 10px; /* Kho?ng c�ch n?i dung t? vi?n */
                                }
                                ...
                                .class-name {
                                    color: #299be4; /* M�u xanh bi?n nh?t */
                                }

                                /* ??nh d?ng cho ng�y b?t ??u v� ng�y k?t th�c */
                                .dates {
                                    margin-top: 10px; /* Kho?ng c�ch t? t�n l?p */
                                }
                                .blk{
                                    color: black;
                                    font-weight: bold;
