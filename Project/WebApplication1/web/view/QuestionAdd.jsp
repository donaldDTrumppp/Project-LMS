                            ...
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <form action="QuestionAdd" method="post" role="form">
                                        ...
                                        <div class="form-group">
                                            <label>Answer:</label>
                                            <input type="text" name="answer" class="form-control"  placeholder="Type the answer" required="">
                                        </div>
                                        <div>
                                            <label for="chapter">Select chapter:</label>
                                            <select name="chapter" id="chapter">
                                                <option value="0">Chapter</option>
                                                <option value="1">Iteration 1: Introduction</option>
                                                <option value="2">Iteration 1: Planning</option>
                                            </select>
                                        </div>
                                        <div>
                                            <label for="subject">Select chapter:</label>
                                            <select name="chapter" id="subject">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="displayOrder"  class="form-control"  placeholder="Order" required="">
                                        </div>
                                        <div>
